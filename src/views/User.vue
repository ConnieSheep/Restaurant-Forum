<template>
  <div class="container py-5">
    <!-- UserProfileCard -->
    <UserProfileCard :user="profile" :initial-follow="isFollowed" />
    <div class="row">
      <div class="col-md-4">
        <!-- UserFollowingsCard -->
        <UserFollowingsCard :user="profile" />
        <!-- UserFollowersCard -->
        <UserFollowersCard :user="profile" />
      </div>
      <div class="col-md-8">
        <!-- UserCommentsCard -->
        <UserCommentsCard :user="profile" />
        <!-- UserFavoriteRestaurantsCard -->
        <UserFavoriteRestaurantsCard :user="profile" />
      </div>
    </div>
  </div>
</template>
